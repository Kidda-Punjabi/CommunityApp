...
export const ui = {
  ...
  cardInteractive:
    "block rounded-3xl border border-zinc-200/60 bg-white p-5 shadow-[0_4px_24px_-6px_rgba(24,24,27,0.06)] transition-all hover:border-violet-200 hover:shadow-[0_6px_28px_-6px_rgba(124,58,237,0.12)]",
  statCard: "rounded-3xl bg-white p-4 shadow-[0_2px_16px_-4px_rgba(24,24,27,0.07)]",

  heroCard:
    "relative block overflow-hidden rounded-3xl bg-violet-600 p-6 shadow-[0_8px_32px_-8px_rgba(124,58,237,0.45)] transition-colors hover:bg-violet-500",
  heroBadge:
  ...
  btnPrimary:
    "inline-flex items-center justify-center rounded-full bg-violet-600 px-6 py-3 text-sm font-semibold text-white shadow-[0_4px_14px_-4px_rgba(124,58,237,0.5)] transition-colors hover:bg-violet-500",
  btnPrimaryBlock:
    "flex w-full items-center justify-center rounded-full bg-violet-600 px-6 py-3.5 text-center text-sm font-semibold text-white shadow-[0_4px_14px_-4px_rgba(124,58,237,0.5)] transition-colors hover:bg-violet-500",
  btnSecondary:
    "inline-flex items-center justify-center rounded-full border border-zinc-200/80 bg-white px-6 py-3 text-sm font-semibold text-violet-600 transition-colors hover:bg-violet-50",
  btnGhost:
    "inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold text-violet-600 transition-colors hover:bg-violet-50",
  btnIcon:
