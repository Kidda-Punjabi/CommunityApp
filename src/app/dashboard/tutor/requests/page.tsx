...
import { loadTutorPendingRescheduleRequests } from "@/lib/calendar/load-sessions";
...
export default async function TutorRequestsPage() {
  ...
  try {
    [rescheduleLoad, coverLoad] = await Promise.all([
  ...
  const totalPending = rescheduleLoad.requests.length;
  ...
  return (
    <div className={ui.page}>
      ...
      {!rescheduleLoad.schemaReady ? <CalendarSchemaNotice className="mb-6" /> : null}
      ...
      <TutorRequestsInbox rescheduleRequests={rescheduleLoad.requests} />
