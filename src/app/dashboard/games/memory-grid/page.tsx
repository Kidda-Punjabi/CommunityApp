...
export default async function MemoryGridDeckSelectPage() {
  ...
  return (
    <div className="flex flex-1 flex-col px-4 py-6">
      ...
      <h1 className="mt-4 text-2xl font-bold text-zinc-900">Memory Grid</h1>
      <p className="mt-1 text-sm text-zinc-500">
        Choose a course level, then pick a flashcard deck.
      </p>
      <div className="mt-6">
        <GameDeckCoursePicker gameSlug="memory-grid" gameTitle="Memory Grid" decks={decks} />
      </div>
    </div>
  );
}
