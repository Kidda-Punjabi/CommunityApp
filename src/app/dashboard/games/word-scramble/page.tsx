...
export default async function WordScrambleDeckSelectPage() {
  ...
  return (
    <div className="flex flex-1 flex-col px-4 py-6">
      ...
      <h1 className="mt-4 text-2xl font-bold text-zinc-900">Word Scramble</h1>
      <p className="mt-1 text-sm text-zinc-500">Choose a flashcard deck to play.</p>
      <div className="mt-6">
        <DeckSelectList gameSlug="word-scramble" gameTitle="Word Scramble" decks={decks} />
      </div>
    </div>
  );
}
